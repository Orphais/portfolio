 ...
 */
class getUsernameHistoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UsernameHistoryRepository' shared autowired service.
     *
     * @return \App\Repository\UsernameHistoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UsernameHistoryRepository.php';

        return $container->privates['App\\Repository\\UsernameHistoryRepository'] = new \App\Repository\UsernameHistoryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
