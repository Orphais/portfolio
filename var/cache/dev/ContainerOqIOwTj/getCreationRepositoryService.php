 ...
 */
class getCreationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CreationRepository' shared autowired service.
     *
     * @return \App\Repository\CreationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CreationRepository.php';

        return $container->privates['App\\Repository\\CreationRepository'] = new \App\Repository\CreationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
