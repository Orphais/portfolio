...
class __TwigTemplate_d3eb4dbf895585ddebff01d0adc64ec9 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["comment"]) {
            ...
            // line 22
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["comment"], "createdAt", [], "any", false, false, false, 22), "d/m/Y H:i"), "html", null, true);
            yield "</p>

                    ";
            // line 24
            if ((CoreExtension::getAttribute($this->env, $this->source, $context["comment"], "user", [], "any", false, false, false, 24) == CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 24, $this->source); })()), "user", [], "any", false, false, false, 24))) {
                // line 25
                yield "                        <form 
                            action=\"";
                // line 26
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("comment_delete", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["comment"], "id", [], "any", false, false, false, 26)]), "html", null, true);
                yield "\" 
                            method=\"post\" 
                ...
                // line 30
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . CoreExtension::getAttribute($this->env, $this->source, $context["comment"], "id", [], "any", false, false, false, 30))), "html", null, true);
                yield "\">
...
";
    ...
    {
        return array (  184 => 40,  180 => 38,  173 => 36,  167 => 34,  160 => 30,  153 => 26,  150 => 25,  148 => 24,  143 => 22,  139 => 21,  135 => 20,  132 => 19,  127 => 18,  119 => 13,  114 => 11,  110 => 10,  104 => 7,  101 => 6,  88 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}", "comments/index.html.twig", "C:\\xampp\\htdocs\\portfolio\\commentaires\\templates\\comments\\index.html.twig");
    }
}
